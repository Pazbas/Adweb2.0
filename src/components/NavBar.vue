<template>
  <b-navbar variant="light" bg="white">
    <b-container>
    <b-navbar-brand href="#" class="text-white">Cursos Disponibles</b-navbar-brand>

      <b-navbar-nav class="ms-auto align-items-center">
        <b-badge variant="danger" class="me-3" v-if="cartCount > 0">
           {{ cartCount }}
        </b-badge>
        <b-nav-item disabled class="text-yellow">{{ userEmail }}</b-nav-item>
